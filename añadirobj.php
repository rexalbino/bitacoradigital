    ...
    <body>
        <?php
            ...
            if(empty($nombre) || empty($serial) || empty($marca) || empty($lastdate) || empty($nextdate) || empty($archivo)){
                ...
                $sql="INSERT INTO `objeto` (`id_objeto`, `nombre`, `no_serie`, `marca`, `status`, `last_date_cal`, `next_date_cal`, `file`) VALUES (NULL, '$nombre', '$serial', '$marca', '$status', '$lastdate', '$nextdate', '$archivod');";
